...
$(document).ready(function(){
	$("#h_email2 option").each(function(){
		if($(this).val()=="${roomDetail.h_email2}"){
...
<body>
	...
	<form id="roomVO" action="${contextPath }/admin/goodsUpdate.do" method="post">
		<div class="mem-item1"><div><h3>사업주 상세 정보</h3></div></div>
		<div class="mem-item2">
			<div class="mem-item2-chil">
				<div class="mem-item2-chil-1"><div>대표자 아이디</div></div>
				<div class="mem-item2-chil-2"><div><input type="text" name="h_id" value="${roomDetail.h_id }" disabled /></div></div>
				<div class="mem-item2-chil-1"><div>대표자명</div></div>
				<div class="mem-item2-chil-2"><div><input type="text" name="h_name" value="${roomDetail.h_name }" /></div></div>
			</div>
			<div class="mem-item2-chil">
				<div class="mem-item2-chil-1"><div>대표자 전화번호</div></div>
				<div class="mem-item2-chil-2"><div><input type="text" name="h_phone" value="${roomDetail.h_phone }" /></div></div>
				<div class="mem-item2-chil-1"><div>대표자 이메일</div></div>
				<div class="mem-item2-chil-2">
					<div>
						<input type="text" name="h_email1" id="email1" value="${roomDetail.h_email1 }" />
			...
			<div class="mem-item2-chil">
				...
				<div class="mem-item2-chil-5"><div><input type="text" name="deputy_phone" value="${roomDetail.deputy_phone }" /></div></div>
				<div class="mem-item2-chil-4"><div>대표자와의 관계</div></div>
				<div class="mem-item2-chil-5"><div><input type="text" name="deputy_department" value="${roomDetail.deputy_department }" /></div></div>
			</div>		
		</div>
		...
		<div class="mem-item2">
			<div class="mem-item2-chil">
				...
				<div class="mem-item2-chil-2"><div><input type="text" name="hostInfo_name" value="${roomDetail.hostInfo_name }" /></div></div>
				<div class="mem-item2-chil-1"><div>가맹점 번호</div></div>
				<div class="mem-item2-chil-2"><div><input type="text" name="h_code" value="${roomDetail.h_code }" disabled /></div></div>
			</div>
			<div class="mem-item2-chil">
				<div class="mem-item2-chil-1"><div>사업자 등록번호</div></div>
				<div class="mem-item2-chil-5"><div><input type="text" name="h_sellerNum" value="${roomDetail.h_sellerNum }" /></div></div>
			...
			<div class="mem-item2-chil">
				...
				<div class="mem-item2-chil-7">
					<div class="mem-item2-chil-3">
						<div>
							<input name="zipcode" id="zipcode" type="text" id="zipcode" name="zipcode" value="${roomDetail.zipcode }" disabled />
					...
					<div class="mem-item2-chil-8"><div class="address-text">도로명 주소 :</div>
						<div><input type="text" id="roadAddress" name="roadAddress" value="${roomDetail.roadAddress }" disabled /></div>
					</div>
					<div class="mem-item2-chil-8"><div class="address-text">지번 주소 :</div>
						<div><input type="text" id="numberAddress" name="numberAddress" value="${roomDetail.numberAddress }" disabled /></div>
					</div>
					<div class="mem-item2-chil-8"><div class="address-text">나머지 주소 :</div>
						<div><input type="text" id="restAddress" name="restAddress" size="20" value="${roomDetail.restAddress }" /></div>
					</div>					
				</div>
			</div>
			<div class="mem-item2-chil">
		...
		<div class="mem-item2">
			<div class="mem-item2-chil">
				...
				<div class="mem-item2-chil-2"><div><input type="text" name="room_number" value="${roomDetail.room_number }" /></div></div>
				<div class="mem-item2-chil-1"><div>가맹점 룸 타입</div></div>
				<div class="mem-item2-chil-2"><div><input type="text" name="room_type" value="${roomDetail.room_type }" /></div></div>
			</div>
			<div class="mem-item2-chil">
				<div class="mem-item2-chil-1"><div>가맹점 룸 체크인</div></div>
				<div class="mem-item2-chil-2"><div><input type="text" name="able_checkIn" value="${roomDetail.able_checkIn }" /></div></div>
				<div class="mem-item2-chil-1"><div>가맹점 룸 체크아웃</div></div>
				<div class="mem-item2-chil-2"><div><input type="text" name="able_checkOut" value="${roomDetail.able_checkOut }" /></div></div>
			</div>
			<div class="mem-item2-chil">
				<div class="mem-item2-chil-1"><div>가맹점 룸 소개 제목</div></div>
				<div class="mem-item2-chil-2"><div><input type="text" name="title" value="${roomDetail.title }" /></div></div>
				<div class="mem-item2-chil-1"><div>가맹점 룸 소개글</div></div>
				<div class="mem-item2-chil-2"><div><input type="text" name="content" value="${roomDetail.content }" /></div></div>
			</div>
			<div class="mem-item2-chil">
				<div class="mem-item2-chil-1"><div>가맹점 룸 가격</div></div>
				<div class="mem-item2-chil-2"><div><input type="text" name="room_fee" value="${roomDetail.room_fee }" />원</div></div>
				<div class="mem-item2-chil-1"><div>최대 수용 인원</div></div>
				<div class="mem-item2-chil-2"><div><input type="text" name="max_number" value="${roomDetail.max_number }" /></div></div>
			</div>
			<div class="mem-item2-chil">
				<div class="mem-item2-chil-1"><div>가맹점 룸 등록일자</div></div>
				<div class="mem-item2-chil-2"><div><input type="text" name="creDate" value="${roomDetail.creDate }" disabled /></div></div>
				<div class="mem-item2-chil-1"><div>가맹점 룸 상태</div></div>
				<div class="mem-item2-chil-2"><div><input type="text" name="del_yn" value="${roomDetail.del_yn }" /></div></div>
			</div>
			<div class="mem-item1">
			...
			<div>
				<table class="styled-table" style="width: 1140px;">
					...
					<tr>
						<td><input style="width: 80px;" type="text" name="bed_type" value="${roomDetail.bed_type }" /></td>
						<td>
							...
							<input style="width: 80px;" type="text" name="quantity" value="${roomDetail.bed_count }">
		...
		<div class="mem-item5">
			<div><button id="updateGoods" type="submit" class="a1" data-oper="modify">수정하기</button></div>
			<div><button class="a2" data-oper="detail" value='<c:out value="${roomDetail.room_code }" />'>돌아가기</a></div>
		</div>
	...
	<form id="operForm" action="${contextPath }/admin/goodsDetail.do" method="get">
			<input type="hidden" name="pageNum" value="${cri.pageNum }" />
			<input type="hidden" name="amount" value="${cri.amount }" />
			<input type="hidden" name="join_startDate" value='<c:out value="${cri.join_startDate }" />'>
			<input type="hidden" name="join_endDate" value='<c:out value="${cri.join_endDate }"/>' >
...
<script type="text/javascript">
$(document).ready(function(){
	$("#updateGoods").on("click", function(e){
		e.preventDefault();
		...
		$("input[name=room_code]").attr("disabled", false);
...
$(".a2").on("click",function(e){
	...
	operForm.attr("action", "${contextPath}/admin/goodsDetail.do");
	operForm.submit();
	});
});
</script>
