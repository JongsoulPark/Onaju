...
.mem-item2-chil-3-email div input{
	width: 175px;
	height: 35px;
	border: 1px solid #E6E6E6;
	border-radius: 5px;
...
.mem-item2-chil-3-email div select{
	width: 175px;
	height: 35px;
	border: 1px solid #E6E6E6;
	border-radius: 5px;
...
$(document).ready(function(){
	...
	$("#u_email2 option").each(function(){
		if($(this).val()=="${memberVO.u_email2}"){
	    	$(this).attr("selected","selected"); // attr적용안될경우 prop
	    }	    
	});
	$("#del_yn option").each(function(){
		if($(this).val()=="${memberVO.del_yn}"){
	    	$(this).attr("selected","selected"); // attr적용안될경우 prop
	    }	    
	});
	...
	<section class="memDetail_con">
		...
		<div class="mem-item2">
			...
			<div class="mem-item2-chil">
				...
				<div class="mem-item2-chil-3-email">
					<div>
						<input type="text" name="u_email1" value="${memberVO.u_email1 }" />
						<select name="u_email2" id="u_email2">
			...
			<div class="mem-item2-chil">
				...
				<div class="mem-item2-chil-2">
					<div>
						...
						위치정보 동의&nbsp;:&nbsp;<input type="checkbox" size="10" name="u_service_02" id="u_service_02" onchange="checkYn2(this)" />
					</div>
				</div>
			</div>
			<div class="mem-item2-chil">
		...
		<div class="mem-item5">
			<div>
				<button id="updateMember" type="submit" class="a1" data-oper="modify">수정하기</button>
			</div>
			<div>
				<button class="a2" data-oper="detail" value='<c:out value="${memberVO.u_id }" />'>돌아가기</button>
			</div>
		</div>
