...
.mem-item2-chil-2-select div select{
	width: 330px;
	height: 35px;
	border: 1px solid #E6E6E6;
	border-radius: 5px;
			...
			<div class="mem-item2-chil">
				...
				<div class="mem-item2-chil-5">
					<div>										
						...
						위치정보 동의:<input type="checkbox" size="10" name="h_service_02" id="h_service_02"  onchange="checkYn2(this)"  />							
					</div>
				</div>
