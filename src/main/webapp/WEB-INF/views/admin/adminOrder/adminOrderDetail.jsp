		...
		<div class="mem-item2">
			...
			<div class="mem-item2-chil">
				...
				<div class="mem-item2-chil-5">
					<div>
						<c:choose>
							<c:when test="${orderVO. use_state == null }"><p>이용전</p></c:when>
							<c:when test="${orderVO. use_state == 'N' }"><p>이용전</p></c:when>
							<c:when test="${orderVO. use_state == 'Y' }"><p>숙박 이용 완료</p></c:when>						
						</c:choose>
					</div>
				</div>
				...
				<div class="mem-item2-chil-5">
					<div>
						<c:choose>
							<c:when test="${orderVO.reservation_state == 'w' }"><p>승인 대기</p></c:when>	
							<c:when test="${orderVO.reservation_state == 'y' }"><p>승인</p></c:when>		
							<c:when test="${orderVO.reservation_state == 'n' }"><p>승인 거부</p></c:when>		
						</c:choose>
					</div>
				</div>
			</div>
